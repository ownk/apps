...
<xsl:stylesheet version="1.0"
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        ...
                        <div class="logo-element">
                            <img class="icono-ownk" src="{//contextPath}/general/img/icono_ownk_vector.svg"
											 height="30px" alt="Ownk" />
                        </div>
                    </li>
                    <li class="active">
	...
	<xsl:template name="nav-bar-top">
		<nav class="navbar navbar-static-top fixed" id="nav-bar-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li>
                    <a href="login.html" class="logo-ownk">
                    
                        <img class="logo-ownk" src="{//contextPath}/general/img/ownk_vector.svg"
											 height="40px" alt="Ownk" />
                    </a>
                </li>
            </ul>
