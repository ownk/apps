						...
						<div class="row  border-bottom white-bg dashboard-header">
							...
							<div class="col-sm-12">
								<div class="pull-left m-r-md">
									<i class="fa fa-cogs  big-icon ownk-color-naranja"></i>
								</div>
								<div class="p-xs">
									...
									<span>Podrás unificar archivos de recaudos BSC,
										transformar los	archivos unificados a estructura SIFI y comparar con
										movimientos de	cuentas bancarias. Consultar los procesos creados,
										los archivos relacionados y descargar los documentos creados</span>
						...
						<div class="wrapper wrapper-content">
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="ibox float-e-margins">
										<div class="ibox-title">
											<span class="label label-success pull-right">Semanal</span>
											<h5>Archivos</h5>
										</div>
										<div class="ibox-content">
								...
								<div class="col-md-3">
									<div class="ibox float-e-margins">
										<div class="ibox-title">
											<h5></h5>
											<div class="ibox-tools">
												<span class="label label-success">Actualizado 2015</span>
											</div>
										</div>
							...
							<div class="row">
								...
								<div class="col-lg-6">
									<div class="ibox float-e-margins">
										<div class="ibox-title">
											<span class="label label-success pull-right">La información ha cambiado</span>
											<h5>User activity</h5>
										</div>
										<div class="ibox-content">
											<div class="row">
