...
public class StringOsmoUtils extends org.apache.commons.lang.StringUtils {
	...
	/**
	 * Convertir un string ASCII en Hexagesimal
	...
	public static Boolean contieneSolo(String texto, String caracteres, Integer lengthMax) {
		if (StringOsmoUtils.esVacio(texto) || texto.length() > lengthMax || !org.apache.commons.lang.StringUtils.containsOnly(texto, caracteres)) {
			return false;
		}
	...
	/**
	 * Valida el correo-e con el patr�n
	...
	/** Validaci�n OR de la cadena para todos los patrones enviados en la lista */
	 ...
	 * diccionario b�sico Diccionario b�sico:
	 * abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890' ' y
	 * remplaza los siguientes caracteres especiales ������������
	 * 
	 * @param
	 * @return
	 */
